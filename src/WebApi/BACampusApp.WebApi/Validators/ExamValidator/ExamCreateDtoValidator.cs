...
namespace BACampusApp.WebApi.Validators.ExamValidator
{
    public class ExamCreateDtoValidator :AbstractValidator<ExamCreateDto>
    {
        ...
        public ExamCreateDtoValidator(IStringLocalizer<Resource> stringLocalizer)
        {
            ...
            RuleFor(x => x.MaxScore).GreaterThan(0).WithMessage($"{_stringLocalizer[Messages.ExamMaxScoreGreatherThanZero]}");
