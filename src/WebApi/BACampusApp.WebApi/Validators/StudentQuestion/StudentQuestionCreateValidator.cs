...
{
    public class StudentQuestionCreateValidator : AbstractValidator<StudentQuestionCreateDto>
    {
        private readonly IStringLocalizer<Resource> _stringLocalizer;

        public StudentQuestionCreateValidator(IStringLocalizer<Resource> stringLocalizer)
        {
